...
In this thesis, we consider two surveys with specific interest. The first is a Stage IV spectroscopic galaxy survey similar to the Euclid satellite. Secondly, we consider in more detail the use of intensity mapping of 21cm emission as a tracer of the galaxy distribution in cosmology. These surveys are discussed in more detail in chapter~\ref{chapter:detect}. 
