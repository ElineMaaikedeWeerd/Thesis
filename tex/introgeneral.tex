...
We will review how the local bias expression in the Newtonian case is derived, and will just quote the results for the more complicated relativistic case when appropriate later on in this thesis. 
