...
\todo[inline]{some more blah also about P in simulations/observations ?? and eg angular, f.s. etc}
...
\begin{figure}[ht!]
	...
	\caption{Snapshot of Millennium simulations~\cite{Springel:2005nw} showing non-linear LSS. There are dense filaments (lighter) surrounded by milder underdensities (darker). This generates a large positive roughly equilateral bispectrum.}
\end{figure}
