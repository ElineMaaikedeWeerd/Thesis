...
Every model of inflation is characterised by specific predictions for the primordial curvature perturbations. Studies of the bispectrum often involve constraining a single amplitude parameter $\fnl$, the non-Gaussian parameter. 
...
\subsection{Flattened or co-linear triangles}
