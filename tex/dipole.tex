...
\subsection{Introduction to the dipole}
...
In this chapter we examine the leading-order relativistic contributions in the galaxy bispectrum, which arive predominantly from RSD and other Doppler-type observational effects. In this chapter we will discuss the dominant relativitistic effects that contribute to the galaxy bispenctrum, that is, 
