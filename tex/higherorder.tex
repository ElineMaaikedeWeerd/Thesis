...
\begin{align}
	...
	&\hphantom{\cH = } + 4 \Q + 16 \Q^2 - 16\frac{\p \Q}{\p \ln\bar{L}} -8 \frac{\Q'}{\cH} + \frac{b_e'}{\cH} + \frac{2}{\chi^{2}\cH^2} \left(1 - \Q + 2\Q^2 - 2\frac{\p \Q}{\p \ln{\bar{L}}} \right) - \frac{2}{\chi \cH} \left[ 4 + 2b_e - 2 b_e \Q - 4\Q + 8\Q^2 - \frac{3\cH'}{\cH^2}(1 - \Q) - 8\frac{\p \Q}{\p \ln{\bar{L}}} - 2\frac{\Q'}{\cH} \right] + \frac{\cH'}{\cH^2} \left(-8 - 2b_e + 8\Q + \frac{3\cH'}{\cH^2} \right) - \frac{\cH''}{\cH^3}
	\end{align}
...
&&  \nonumber \\
&&{} , \label{bca}\\
\mathcal{B} &=& 2\HH\bigg[-3+4b_{e}+2b_e\frac{(1-\Q)}{\chi\HH}-b_{e}^{2}+2b_{e}\Q -6\Q-\frac{b_{e}'}{\HH}-\frac{6(1-\Q)}{\chi\HH}+2\bigg(1-\frac{1}{\chi\HH}\bigg)\frac{\Q'}{\HH}\bigg], \\
\mathcal{C} &=& 2\HH\bigg[-3+f(3-b_{e})-3b_{e}-2b_e\frac{(1-\Q)}{\chi\HH}+\frac{b_{e}'}{\HH}+b_{e}^{2}-4b_{e}\Q+12\Q+\frac{6(1-\Q)}{\chi\HH}-2\bigg(2-\frac{1}{\chi\HH}\bigg)\frac{\Q'}{\HH}\bigg], \\
\mathcal{D} &=& 4 +2f\bigg[-3+f+2b_{e}-3\Q-\frac{4(1-\Q)}{\chi\HH}-\frac{2\HH'}{\HH^{2}}\bigg] +\frac{2f'}{\HH}-6b_{e}-2b_{e}^{2}+12b_{e}\Q-{8}\Q-16\Q^{2}+16\frac{\p \Q}{\p \ln{\bar{L}}}  \nonumber \\
&&+12\frac{\Q'}{\HH} -2\frac{b_{e}'}{\HH} -\frac{4}{\chi^{2}\HH^{2}}\bigg(1-\Q+2\Q^{2}-2\frac{\p \Q}{\p \ln{\bar{L}}}\bigg) - \frac{4}{\chi \HH}\bigg[-1 -2b_{e}+2b_{e}\Q+\Q-6\Q^{2}+\frac{3\HH'}{\HH^{2}}(1-\Q)  \nonumber \\
&& +6\frac{\p \Q}{\p \ln{\bar{L}}} + 2\frac{\Q'}{\HH}\bigg]+ \frac{2\HH'}{\HH^{2}}\bigg(3+2b_{e}-6\Q-\frac{3\HH'}{\HH^{2}}\bigg) + \frac{2\HH''}{\HH^{3}} , \\
\mathcal{E} &=&  -4-b_{e}+b_{e}^{2}-4b_{e}\Q+ {6}\Q+4\Q^{2}-4\frac{\p \Q}{\p \ln{\bar{L}}} - 4\frac{\Q'}{\HH} + \frac{b_{e}'}{\HH} + \frac{2}{\chi^{2}\HH^{2}}\bigg(1-\Q+2\Q^{2}-2\frac{\p \Q}{\p \ln{\bar{L}}}\bigg) \nonumber \\
&& + \frac{2}{\chi\HH}\bigg[3-2b_{e}+2b_{e}\Q-3\Q-4\Q^{2}+\frac{3\HH'}{\HH^{2}}(1-\Q) + 4\frac{\p \Q}{\p \ln{\bar{L}}} + 2\frac{\Q'}{\HH}\bigg] + \frac{\HH'}{\HH^{2}}\bigg(3-2b_{e}+{4}\Q+\frac{3\HH'}{\HH^{2}}\bigg) - \frac{\HH''}{\HH^{3}}.\nonumber \\
&& \label{bce}
