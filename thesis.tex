...
% Following are to make margins wider for the todo notes in the margin 
...
\sisetup{mode=math,detect-all,parse-numbers = false}
...
%To generate todolist and add it to table of contents:
% \todototoc
% \listoftodos
...
\bibliography{tex/bib/thesis_bib}
% 
